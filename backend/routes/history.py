...
from ..services.history import _serialize_history_response, _get_versions_for_generation
...
async def get_generation(
    ...
    versions, active_version_id = _get_versions_for_generation(gen.id, db)
    return _serialize_history_response(gen, profile_name, versions, active_version_id)
...
async def export_generation(
    ...
    filename = f"generation-{safe_text}.eburon-voice.zip"
