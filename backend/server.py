"""
Entry point for PyInstaller-bundled Eburon server.
...
if "--version" in sys.argv:
    ...
    print(f"eburon-server {__version__}")
    sys.exit(0)
...
logger.info("=" * 60)
logger.info("Eburon server starting up...")
...
if __name__ == "__main__":
    try:
        parser = argparse.ArgumentParser(description="Eburon backend server")
        parser.add_argument(
            "--host",
            type=str,
            default="127.0.0.1",
