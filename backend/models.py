...
class GenerationRequest(BaseModel):
    ...
    engine: Optional[str] = Field(default="eburon-athena", max_length=64)
...
class GenerationResponse(BaseModel):
    ...
    engine: Optional[str] = "eburon-athena"
    model_size: Optional[str] = None
    provider: str = "eburon-edge-voice"
...
class ModelStatus(BaseModel):
    ...
    voice_cloning_supported: bool = False
    status: str = "enabled"
    provider: str = "eburon-edge-voice"
    capabilities: List[str] = Field(default_factory=list)
    downloaded: bool
