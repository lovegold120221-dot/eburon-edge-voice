  ...
  return (
    <div className="space-y-8 max-w-2xl">
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <div className="text-sm font-medium">Open API Docs</div>
            <div className="text-xs text-muted-foreground">Interactive local reference</div>
          </div>
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <div className="text-sm font-medium">Visit eburon.ai</div>
      ...
      <SettingSection>
        <SettingRow
          title="Server URL"
          description={`The address of your ${APP_NAME} backend server.`}
          action={
    ...
    <div className="rounded-lg border border-border/60 p-4 space-y-3">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Integrate {APP_NAME} into your workflow via the REST API at{' '}
