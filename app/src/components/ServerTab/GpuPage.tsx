  ...
  return (
    <div className="space-y-8 max-w-2xl">
      ...
      <p className="text-xs text-muted-foreground/60 leading-relaxed">
        {APP_NAME} automatically detects and uses the best available GPU on your system. On Apple
        ...
        no GPU is detected, {APP_NAME} falls back to CPU — all engines still work, just slower.
      </p>
    </div>
  );
}
