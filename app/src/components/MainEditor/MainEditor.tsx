    ...
    if (file) {
      if (!isSupportedArchiveFilename(file.name)) {
        toast({
          ...
          description: `Please select a valid ${ARCHIVE_EXTENSION} file. Legacy ${LEGACY_ARCHIVE_EXTENSION} imports still work.`,
          variant: 'destructive',
        });
        return;
      }
      ...
      <div className="flex flex-col min-h-0 overflow-hidden relative lg:overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 z-10">
          <div className="flex items-center justify-between mb-4 px-1">
            <div>
              <p className="text-[10px] uppercase tracking-[0.22em] text-muted-foreground/55">
                Local Studio
              </p>
            ...
            <div className="flex gap-2">
              ...
              <input
                ref={fileInputRef}
                type="file"
                accept={`${ARCHIVE_EXTENSION},${LEGACY_ARCHIVE_EXTENSION}`}
