...
const LOADING_MESSAGES = [
  ...
  'Initializing flagship speech runtime...',
];
...
function App() {
  ...
  useEffect(() => {
    ...
    if (!import.meta.env?.PROD) {
      ...
      window.__eburonServerStartedByApp = false;
      return;
    }
    ...
    platform.lifecycle
      ...
      .then((serverUrl) => {
        ...
        // @ts-expect-error - adding property to window
        window.__eburonServerStartedByApp = true;
      })
      .catch((error) => {
        ...
        <div className="text-center space-y-6">
          <div className="flex justify-center relative">
            ...
            <img
              src={appLogo}
              alt={APP_NAME}
              className="w-72 max-w-[78vw] h-auto object-contain animate-fade-in-scale relative z-10"
            />
          </div>
          <div className="animate-fade-in-delayed">
            <p className="mb-3 text-xs font-medium uppercase tracking-[0.28em] text-muted-foreground/60">
              {APP_NAME}
            </p>
            <ShinyText
