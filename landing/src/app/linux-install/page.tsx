...
export const metadata: Metadata = {
  title: 'Linux Install - Eburon Voice',
  description: 'Build Eburon Voice from source on Linux. Clone, setup, and build in three commands.',
};
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="rounded-lg border border-border bg-card/60 p-4 font-mono text-sm">
                  ...
                  <div>git clone https://github.com/lovegold120221-dot/eburon-edge-voice.git</div>
                  <div>cd eburon-edge-voice</div>
                </div>
